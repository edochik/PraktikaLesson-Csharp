...
int[] arraynewA = NewArray(6);

PrintArrah(arraynewA);

void FindElementd(int[] array, find)
{
    for (int i = 0; i < array.Length; i++)
    {
        if (array[i] == find) Console.WriteLine(find + "Элемент есть");
    }
}

FindElementd(arraynewA,1);
